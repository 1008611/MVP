...
import com.wildwolf.mvp.ui.fragemnt.TypeFragment;
import com.wildwolf.mvp.utils.ImageLoader;
import com.wildwolf.mvp.utils.ResourceUtil;
import com.wildwolf.mvp.utils.ShareUtil;
import com.wildwolf.mvp.utils.SnackBarUtil;
...
public class MainActivity extends BaseActivity {
    ...
    private void initNavigationView() {
        ...
        ImageLoader.loadCircle(mContext, R.drawable.csdn, icon);
        TextView name = (TextView) mNavView.getHeaderView(0).findViewById(R.id.nav_head_name);
        name.setText(R.string.app_name);
        mNavView.setCheckedItem(R.id.nav_girl);//设置默认选中
